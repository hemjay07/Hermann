...
export default class Navigation extends Component {
  ...
  addEventListeners() {
    ...
    if (this.elements.button) {
      ...
      this.elements.button.addEventListener('mouseenter', this.onButtonEnter.bind(this));
      this.elements.button.addEventListener('mouseleave', this.onButtonLeave.bind(this));
    }
    ...
    if (this.elements.overlay) {
      this.elements.overlay.addEventListener('click', this.onOverlayClick.bind(this));
    }
  }
  ...
  openMenu() {
    ...
    timeline.to(this.elements.menuBackground, {
      scaleX: 1,
    ...
    // Stagger menu items
    timeline.to(this.elements.menuItems, {
      y: 0,
      opacity: 1,
      duration: 0.8,
      stagger: 0.1,
  ...
  removeEventListeners() {
    ...
    if (this.elements.button) {
      ...
      this.elements.button.removeEventListener('mouseenter', this.onButtonEnter);
      this.elements.button.removeEventListener('mouseleave', this.onButtonLeave);
    }
    if (this.elements.menuLinks) {
      this.elements.menuLinks.forEach(link => {
