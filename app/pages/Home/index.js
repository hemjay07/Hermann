...
export default class Home extends Page {
  constructor() {
    super({
      ...
      elements: {
        ...
        pinnedArt: ".pinned-art",
        artworkContainer: ".pinned-art .artwork",
      },
    });
  ...
  setupRotation() {
    ...
    slider.style.transform =
      "perspective(1000px) rotateX(-16deg) rotateY(0deg)";
  ...
  startRotationLoop() {
    const animate = (currentTime) => {
      ...
      if (this.isInitializing) {
        ...
        this.currentSpeed =
          (this.initialSpeed -
            (this.initialSpeed - this.rotationSpeed) * progress) *
      ...
      this.elements.slider.style.transform = `perspective(1000px) rotateX(-16deg) rotateY(${this.rotation}deg)`;
  ...
  onWheel(event) {
    ...
    const scrollInfluence =
      absVertical > absHorizontal ? event.deltaY * 1.5 : event.deltaX * 1.5;
    ...
    if (
      ...
      this.currentSpeed =
        this.directionMultiplier * Math.max(this.rotationSpeed, scrollSpeed);
    } else {
