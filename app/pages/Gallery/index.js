...
export default class Gallery extends Page {
  ...
  createEnterAnimation() {
    ...
    timeline.from(
      ...
      "-=0.6"
    ); // Overlap more with previous animation
  ...
  setupGallery() {
    ...
    this.elements.previewBackground = this.elements.preview.querySelector(
      ".preview__background"
    );
  }
  addEventListeners() {
  ...
  openPreview(gridItem) {
    ...
    this.previewContainer = this.elements.preview.querySelector(
    ...
    setTimeout(() => {
      if (!this.previewContainer.contains(this.loader)) {
    ...
    const timeline = GSAP.timeline({
      onComplete: () => {
        ...
        fullImage.src = img.dataset.large;
    ...
    const otherImages = [
      ...this.elements.grid.querySelectorAll(".grid_item"),
    ...
    timeline
      ...
      .to(
        this.elements.previewBackground,
        {
          opacity: 1,
          duration: 1,
          ease: "power2.out",
  ...
  closePreview() {
    ...
    this.state.timeline.eventCallback("onReverseComplete", () => {
      ...
      const clone = this.elements.preview.querySelector(
